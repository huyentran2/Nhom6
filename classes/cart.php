...
class cart
{
	...
	public function update_quantity_cart($quantily, $cartId){
		$quantity = mysqli_real_escape_string($this->db->link,$quantily);
		$cartId = mysqli_real_escape_string($this->db->link,$cartId);

		$query = "UPDATE tbl_cart SET quantily = '$quantily' WHERE cartId = '$cartId'";

		$result = $this->db->update($query);
		if($result){
			$msg = "<span class='success'>Product quantily update Successfully</span>";
			return $msg;
		}else{
			$msg = "<span class='error'>Product quantily update not Success</span>";
		}
	}
	...
	public function del_cart($cartid){
		...
		if($result){
			...
			$msg = "<span class='error'>Delete not Success</span>";
			return $msg;
		}
	}
	...
	public function insertOrder($customer_id)
	{
		...
		if($get_product){
			while($result = $get_product->fetch_assoc()){
				...
				$query_order = "INSERT INTO tbl_order(productId,productName,quantily,price,image,customer_id) VALUES('$productid','$productName','$quantily','$price','$image','$customer_id')";
	...
	public function get_cart_orderd($customer_id){
		$query = "SELECT * FROM tbl_order WHERE customer_id = '$customer_id'";
		$get_cart_orderd = $this->db->select($query);
		return $get_cart_orderd;
