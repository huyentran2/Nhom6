...
class product
{
	...
	public function insert_product($data,$files){
		...
		//kiểm tra hình ảnh và lấy hình ảnh cho vào folder uploads
	...
	public function update_product($data,$files,$id){
		...
		if($productName=="" || $brand=="" || $category=="" || $product_desc=="" || $price=="" || $type=="") {
			...
			if(!empty($file_name)){
				...
				//Nếu ng dùng không chọn ảnh
	...
	public function del_product($id){
		...
		if($result){
			$alert = "<span class='success'>Product delete Success</span>";
			return $alert;
		}else{
	...
	public function getLastestOsun(){
		$query = "SELECT * FROM tbl_product WHERE brandId = '1' order by productId desc LIMIT 1";
		$result = $this->db->select($query);
		return $result;
	}
	public function getLastestKing(){
		$query = "SELECT * FROM tbl_product WHERE brandId = '3' order by productId desc LIMIT 1";
		$result = $this->db->select($query);
		return $result;
	}
	public function getLastestZocker(){
		$query = "SELECT * FROM tbl_product WHERE brandId = '4' order by productId desc LIMIT 1";
		$result = $this->db->select($query);
		return $result;
	}
	public function getLastestZasami(){
...
// 			    $result = $this->db->insert($query);
// 			      if($result){
// 				    $alert = "<span class='success'>Slider Added sfully</span>";
// 				    return $alert;
// 			      }else{
