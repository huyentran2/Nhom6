			  ...
			  <div class="header_top_right">
			    <div class="search_box">
				    <form action="search.php" method="POST">
				    	<input type="text" placeholder="Tìm kiếm sản phẩm" name="tukhoa" >
				    	<input type="submit" name="search_product" value="Tìm Kiếm">
				    </form>
			    </div>
			    <div class="shopping_cart">
			      ...
			      if(isset($_GET['customer_id'])){
			      	...
			      	$delCompare = $crt->del_compare($customer_id);
			      	Session::destroy();
			      }
			      ?>
...
<div class="menu">
	<ul id="dc_mega-menu-orange" class="dc_mm-orange">
	  ...
	  $check_order = $crt->check_order($customer_id);
	  if($check_order==true){
